...
public class BankStatementAnalyzer {
	...
	public static void main(String[] args) throws FileNotFoundException, ParseException {
		...
		// String fileName = "src/main/resources/bankstatement.csv";
		...
		// System.out.println("Number of bank transations: " + transactions.size());
		// System.out.println("---------------------------");
		...
		// }
		// }
		// System.out.println("The category that is spent on the most is: [" +
		// getKey(map, Collections.max(map.values())) + "] at a value of: [$" +
		...
		// System.out.println("Top 1 transaction is: [" + top1[0] + "] With Value: [" +
		// top1[1] + "]");
		// System.out.println("Top 2 transaction is: [" + top2[0] + "] With Value: [" +
		// top2[1] + "]");
		// System.out.println("Top 3 transaction is: [" + top3[0] + "] With Value: [" +
		// top3[1] + "]");
		// }
